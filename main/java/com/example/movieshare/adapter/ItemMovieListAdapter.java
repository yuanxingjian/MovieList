...
public class ItemMovieListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<SimpleSubjectBean> movieList = null;//数据源
    private Context context;//上下文
    private LayoutInflater layoutInflater;
    public int upDown=0;//下拉标志，定义当前下拉状态，默认不是下拉
    public int totalSize=0;//电影总数
    FootViewHolder fvh;//下拉布局
    ...
    //构造方法
    public ItemMovieListAdapter(List<SimpleSubjectBean> movieList, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType==0) {
            View v = layoutInflater.inflate(R.layout.item_movielist_layout, parent, false);
    ...
    class FootViewHolder extends RecyclerView.ViewHolder{
        ...
        public void update(){
            ...
            totalSize+=movieList.size();//记录已经显示了几条数据
        }
        public void fail(){
            pbViewLoadTip.setVisibility(View.GONE);
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        private ImageView ivItemSimpleSubjectImage;//电影图片
        private LinearLayout llItemSimpleSubjectRating;
        private RatingBar rbItemSimpleSubjectRating;//星级评价
        private TextView tvItemSimpleSubjectRating;//评价的分数
        private TextView tvItemSimpleSubjectCount;//评价人数
        private TextView tvItemSimpleSubjectTitle;//电影名
        private TextView tvItemSimpleSubjectOriginalTitle;//原电影名
        private TextView tvItemSimpleSubjectGenres;//影片类型
        private TextView tvItemSimpleSubjectDirector;//导演
        private TextView tvItemSimpleSubjectCast;//主演
